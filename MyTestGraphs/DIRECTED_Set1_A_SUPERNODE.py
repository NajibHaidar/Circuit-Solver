...
A.add_node('v1', index=0, skip=False, supernode=[False, None])  # associate the index of the node it's super noded with
A.add_node('v2', index=1, skip=False, supernode=[False, None])
A.add_node('v3', index=2, skip=False, supernode=[False, None])

# A.add_node('GND', index=-2, supernode=[False, -1])
A.add_node('GND', index=-2)

# add edges to the graph representing the connections
A.add_edge('v3', 'v1', type='Vsource', voltage=1)
A.add_edge('v1', 'GND', type='resistor', resistance=4)
A.add_edge('v1', 'v2', type='resistor', resistance=2)
A.add_edge('v2', 'GND', type='resistor', resistance=3)
A.add_edge('v2', 'v3', type='resistor', resistance=1)
